...
export class StockTable extends Component {
  ...
  render() {
    const { stock, deleteItem, addStock, subtractStock } = this.props;
    return (
      <Fragment>
...
const TableTemplate = (stock, deleteItem) => {
  return (
    <Fragment>
      <h2>Stock in Market</h2>
      <table className='table table-striped'>
...
export default connect(mapStateToProps, { getStock })(StockTable);
